module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            js: {
                src: [ "dev/js/requestAnimationFrame.js", "dev/js/cart.js","dev/js/wheel.js","dev/js/spoon.js","dev/js/catapult.js","dev/js/ball.js","dev/js/input.js","dev/js/game.js","dev/js/application.js" ],
    ...
    grunt.registerTask('build', ['jshint', 'htmlhint', 'concat', 'uglify', 'cssmin']);
